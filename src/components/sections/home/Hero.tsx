...
export function Hero() {
  return (
    ...
    >
      <Container className="flex flex-col items-center pb-10 pt-6 text-center sm:pb-16 sm:pt-20 lg:pt-28">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="-mx-4 max-w-xl text-pretty text-base leading-relaxed text-white/60 sm:mx-0 sm:text-lg">
